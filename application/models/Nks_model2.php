...
class Nks_model2 extends CI_Model
{
    ...
    function json($da,$ad) {
        ...
        $this->datatables2->where($da);
        $this->datatables2->where($ad);
        $this->datatables2->group_by("json_extract(uncompress(questionnaire), '$.id.P108')");
        //add this line for join
        //$this->datatables2->join('table2', 'vis.field = table2.field');
        //$this->datatables2->add_column('action', anchor(site_url('korwil1/nks/$1'),'<i class="fa fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-danger btn-sm')), 'substr(caseids, 11, 5)');
