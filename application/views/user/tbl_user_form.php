        ...
        <div class="box box-warning box-solid">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                ...
                <table class='table table-bordered>'        
                    ...
                    <tr><td width='200'>Provinsi <?php echo form_error('noprov') ?></td><td>
                            <?php echo select2_prov('noprov', 'tbl_prov','noprov', 'kodeprov','nm_prov','Kode || Provinsi','ASC',$noprov) ?>
                            <!--<input type="text" class="form-control" name="id_user_level" id="id_user_level" placeholder="Id User Level" value="<?php echo $noprov; ?>" />--></td></tr>
