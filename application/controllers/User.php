...
class User extends CI_Controller
{
    ...
    public function create_action() 
    {
		...
		'images'        => 'user.png',
		'noprov'        =>  $this->input->post('noprov',TRUE),
    ...
    public function update($id) 
    {
		...
		'noprov'        => set_value('noprov', $row->noprov),
	...
	$this->form_validation->set_rules('noprov', 'Kode || Provinsi', 'trim|required');
